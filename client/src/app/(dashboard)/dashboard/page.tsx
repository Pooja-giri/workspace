...
export default function DashboardPage() {
  ...
  const deptDistributionOption = useMemo<EChartsOption>(() => {
    ...
    return {
      color: ["#0F766E", "#2563EB", "#0D9488", "#1E3A8A", "#16A34A", "#F59E0B"],
      tooltip: {
        trigger: "item",
        formatter: "{b}: {c} ({d}%)",
      },
      ...
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
        <div>
          <div className="flex items-center gap-2">
            <span className="rounded-md bg-[#0F766E] px-2 py-0.5 text-[11px] font-semibold uppercase tracking-wider text-white shadow-xs">
              {role?.name || "HR Admin"}
            </span>
            <span className="text-xs text-slate-400">Workforce Dashboard</span>
          </div>

          <h1 className="mt-1 text-2xl lg:text-3xl font-bold tracking-tight text-[#0F172A]">
            {greeting}, {firstName}
          </h1>
        ...
        <div className="flex items-center rounded-xl border border-slate-200 bg-slate-100 p-1">
          <button
            ...
            className={`rounded-lg px-3.5 py-1.5 text-xs font-semibold transition ${
              activeTab === "ORG" ? "bg-[#0F766E] text-white shadow-xs" : "text-slate-600 hover:text-slate-900"
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-1.5 rounded-lg px-3.5 py-1.5 text-xs font-semibold transition ${
              activeTab === "SELF" ? "bg-[#0F766E] text-white shadow-xs" : "text-slate-600 hover:text-slate-900"
            }`}
          >
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6 lg:col-span-2 shadow-xs">
              ...
              <div className="mt-6 space-y-5">
                <LeaveProgressBar title="Annual Leave" percentage={72} used={1440} total={2000} color="bg-[#0F766E]" />
                <LeaveProgressBar title="Sick Leave" percentage={41} used={410} total={1000} color="bg-[#2563EB]" />
                <LeaveProgressBar title="Casual Leave" percentage={55} used={660} total={1200} color="bg-[#16A34A]" />
              </div>
            </div>
          ...
          <div className="rounded-2xl border border-teal-100 bg-teal-50/40 p-6">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex items-center gap-2">
                <Link
                  href="/leave"
                  className="inline-flex items-center gap-1.5 rounded-xl bg-[#0F766E] px-4 py-2.5 text-xs font-semibold text-white transition hover:bg-[#115E59] shadow-sm"
                >
